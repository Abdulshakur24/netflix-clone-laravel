...
<div @click="open = true" class="flex flex-col mr-3 overflow-hidden rounded-md" style="background-color:  #181818">
    <div @click="open = true" class="w-72">
        <a href="{{ route('movies.show', $movie['id']) }}">
            <img class="w-full h-56 cursor-pointer" src="{{ 'https://image.tmdb.org/t/p/w500' . $movie['poster_path'] }}"
                alt="poster">
        </a>
    </div>
    ...
    <div x-show="open" x-cloak class="">
        ...
        <div class="flex flex-row items-center justify-between m-4">
            <div class="flex items-center justify-center space-x-2">
                ...
                <button
                    class="flex items-center justify-center w-8 h-8 border-2 border-gray-400 rounded-full hover:border-gray-100">
                    <x-icons name="plus" />
                </button>
                <button
                    class="flex items-center justify-center w-8 h-8 border-2 border-gray-400 rounded-full hover:border-gray-100">
            ...
            <div class="">
                <button
                    class="flex items-center justify-center w-8 h-8 border-2 border-gray-400 rounded-full hover:border-gray-100 focus:outline-none ">
